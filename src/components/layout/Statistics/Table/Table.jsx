...
{transactionType ?
      <div className={css.total}>
        ...
        <span className={css.expense}>{formatTotal(transactionType ? total.expense : total.income)}</span>
        </div> :
      <div className={css.total}>
      <span className={css.expenses}>Incomes:</span>
      <span className={css.income}>{formatTotal(transactionType ? total.expense : total.income)}</span>
      </div>
      }
    </div>
  );
